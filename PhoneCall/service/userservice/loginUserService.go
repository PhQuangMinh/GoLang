...
func (userService *UserService) Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			...
			handlers.LogErr("Email does not exist")
			return
		}
		...
		err = userService.RedisService.Client.Set(context.Background(), "access_token_"+strconv.FormatInt(foundUser.Id, 10), token, time.Hour*100).Err()
		if err != nil {
